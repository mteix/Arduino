...
int stateButton = 0; //starts low

/*
 * HW NOTE:
 * THE BUTTON MUST BE CONNECTED AS FOLLOWS:
 * UPPER PIN: TO DIGITAL PORT
 * LOWER PINS: ONE TO + AND OTHER TO GROUND WITH 
 * A 300 OHM RESISTOR
 */
...
void loop() {
  ...
  stateButton=LOW; //RESET THE BUTTON
